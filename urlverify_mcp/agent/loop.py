...
TOOLS: list[dict[str, Any]] = [
    ...
    {"type": "function", "function": {"name": "wikidata_lookup", "description": "Structured lookup: entity, official website (P856) and official source repository (P1324), each with revision-history stability, developer/publisher, aliases.",
        "parameters": {"type": "object", "properties": {"name": {"type": "string"}}, "required": ["name"]}}},
    {"type": "function", "function": {"name": "wikipedia_history", "description": "Wikipedia article infobox website, repository and developer fields, with revision-history stability over the configured window.",
